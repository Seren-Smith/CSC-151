...
(* Given the names of a message file and a pad file, reads them and then enciphers *)
let encipher_file (mfile :string) (pfile :string) :string =
...
;; print_endline (encipher_file Sys.argv.(1) Sys.argv.(2))